                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                {{ $auth->full_name }} - {{ $auth->roles()->first()->name }}
                                @php(setLocale(LC_TIME,'pt-BR'))
                                <small>
                                    @lang('messages.global.membership',
                                    ['date' => $auth->created_at->formatLocalized('%d de %B - %Y')])
                                </small>
                            </p>
                        </li>
                    {{--<!-- Menu Body -->
                    ...
                    <!-- Menu Footer-->
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ route('admin.users.read', ['user' => $auth]) }}" class="btn btn-default btn-flat">Profile</a>
                            </div>
                            <div class="pull-right">
                                <a href="#logout" class="btn btn-default btn-flat"
                                   onclick="$('#logoutForm').submit(); return false">Sign out</a>
