...
var view = exports.view = function view(_view, file) {
    try {
        return function (resolve) {
            return __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(259)("./" + _view + '/' + (file ? file : 'index.vue'))]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
        };
    } catch (e) {
        console.log(e);
    }
...
var component = exports.component = function component(_component, file) {
    try {
        return function (resolve) {
            return __webpack_require__.e/* require */(1).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(258)("./" + _component + '/' + (file ? file : 'index.vue'))]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
        };
    } catch (e) {
        console.log(e);
    }
...
var files = __webpack_require__(254);
var context = {};
...
var _resolver = __webpack_require__(148);

var rPlayer = (0, _resolver.component)('rPlayer');
var rFooter = (0, _resolver.component)('rFooter');
exports.default = {
...
var _laravelEcho = __webpack_require__(245);
...
try {
    window.$ = window.jQuery = __webpack_require__(244);
...
exports.default = new _vue2.default({
    ...
    render: function render(h) {
        return h(__webpack_require__(250));
    },
    mounted: function mounted() {
...
_vue2.default.use(__webpack_require__(147));
_vue2.default.use(__webpack_require__(19));
_vue2.default.use(__webpack_require__(20));
_vue2.default.use(__webpack_require__(253));
_vue2.default.use(__webpack_require__(252));
...
router.beforeEach(function (to, from, next) {
    if (to.meta.fetch) {
        ...
        axios.get('' + to.meta.fetch.url + (to.query.page ? '?page=' + page : '')).then(function (res) {
            _store2.default.dispatch(to.meta.fetch.action, res.data);
...
exports.default = [{
    path: '/',
    name: 'Home',
    component: (0, _resolver.view)('Home')
}, {
    path: '/schedule',
    name: 'Schedule',
    component: (0, _resolver.view)('Schedule')
}, {
    path: '/schedule/:id',
    name: 'Schedule.Child',
    component: (0, _resolver.view)('Schedule/Child')
}, {
    path: '/news',
    name: 'News',
    component: (0, _resolver.view)('News'),
    meta: {
        fetch: {
            url: '/api/news',
            action: 'News/setNews',
    ...
    path: '/news/:id',
    name: 'News.Child',
    component: (0, _resolver.view)('News/Child'),
    beforeEnter: function beforeEnter(to, from, next) {
        axios.get('/api/news/' + to.params.id).then(function (res) {
            _store2.default.dispatch('News/setCurrent', res.data);
        }).catch(console.log);
    ...
    path: '/interviews',
    name: 'Interviews',
    component: (0, _resolver.view)('Interviews'),
    meta: {
        fetch: {
            url: '/api/interviews',
    ...
    component: (0, _resolver.view)('Interviews/Child'),
    beforeEnter: function beforeEnter(to, from, next) {
        axios.get('/api/interviews/' + to.params.id).then(function (res) {
            _store2.default.dispatch('Interviews/setCurrent', res.data);
        }).catch(console.log);
    ...
    path: '/posts',
    name: 'Posts',
    component: (0, _resolver.view)('Posts'),
    meta: {
        fetch: {
            url: '/api/posts',
    ...
    path: '/posts/:id',
    name: 'Posts.Child',
    component: (0, _resolver.view)('Posts/Child'),
    beforeEnter: function beforeEnter(to, from, next) {
        axios.get('/api/posts/' + to.params.id).then(function (res) {
            _store2.default.dispatch('Posts/setCurrent', res.data);
        }).catch(console.log);
    ...
    path: '/events',
    name: 'Events',
    component: (0, _resolver.view)('Events'),
    meta: {
        fetch: {
            url: '/api/events',
    ...
    path: '/events/:id',
    name: 'Events.Child',
    component: (0, _resolver.view)('Events/Child', 'index.vue'),
    beforeEnter: function beforeEnter(to, from, next) {
        axios.get('/api/events/' + to.params.id).then(function (res) {
            _store2.default.dispatch('Events/setCurrent', res.data);
        }).catch(console.log);
        next();
    }
}, {
    path: '/gallery',
    name: 'Gallery',
    component: (0, _resolver.view)('Gallery'),
    meta: {
        fetch: {
            url: '/api/photos',
    ...
    path: '/videos',
    name: 'Videos',
    component: (0, _resolver.view)('Videos'),
    meta: {
        fetch: {
            url: '/api/videos',
    ...
    path: '/team',
    name: 'Team',
    component: (0, _resolver.view)('Team'),
    meta: {
        fetch: {
            url: '/api/teams',
            action: 'Team/setTeam',
    ...
    path: '/about',
    name: 'About',
    component: (0, _resolver.view)('About')
}, {
    path: '/partners',
    name: 'Partners',
    component: (0, _resolver.view)('Partners'),
    meta: {
        fetch: {
            url: '/api/partners',
    ...
    path: '/chat',
    name: 'Chat',
    component: (0, _resolver.view)('Chat'),
    beforeEnter: function beforeEnter(to, from, next) {
        var _this = this;
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            if (_store2.default.getters['Chat/messages'].length) {
                                _context.next = 6;
                                break;
                            }
                        ...
                        case 3:
                            ...
                            _store2.default.dispatch('Chat/setMessages', data);
...
exports.default = {
    ...
    actions: {
        setAs: function setAs(_ref, payload) {
            ...
            _jsCookie2.default.set('as', payload, { expires: 7 });
            commit('SET_AS', payload);
        },
        removeAs: function removeAs(_ref2) {
            var commit = _ref2.commit;

            _jsCookie2.default.remove('as');
            commit('REMOVE_AS');
            commit('SET_MESSAGE', '');
        },
        ...
        addMessage: function addMessage(_ref5, payload) {
            var _this = this;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                _context.next = 6;
                                return _axios2.default.post('/api/messages', { body: body, name: name, email: email });
        ...
        moduleInit: function moduleInit(_ref7, store) {
            ...
            if (_jsCookie2.default.get('as')) {
                dispatch('setAs', _jsCookie2.default.getJSON('as'));
            }
        }
    },
    getters: {
...
var defaultPage = [{ name: 'title', content: 'Titulo Padrão' }];
...
exports.default = {
    ...
    actions: {
        ...
        vote: function vote(_ref2, payload) {
            var _this = this;

            var commit = _ref2.commit,
                getters = _ref2.getters;
            return (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
                var _ref3, data, voted;
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return _axios2.default.post('/api/admin/radio/polls/options/' + payload + '/vote');

                            case 2:
                                _ref3 = _context.sent;
                                data = _ref3.data;
                                voted = _jsCookie2.default.getJSON('VOTED');


                                voted.push(getters.poll.id);

                                _jsCookie2.default.set('VOTED', (0, _lodash.uniq)(voted), { expires: 30 });
                                commit('SET_POLL', data);
                                console.log(_jsCookie2.default.getJSON('VOTED'));
        ...
        moduleInit: function moduleInit(_ref4) {
            var _this2 = this;
                ...
                return _regenerator2.default.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                if (!_jsCookie2.default.getJSON('VOTED')) _jsCookie2.default.set('VOTED', []);
                                _context2.next = 3;
...
module.exports = !__webpack_require__(10) && !__webpack_require__(150)(function(){
